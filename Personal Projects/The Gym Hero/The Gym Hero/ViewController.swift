...
//        ]
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "gear"), style: .done, target: self, action: #selector(gearTapped))
    }
    ...
    func localLang() {
        ...
        //timerModeLabel.titleLabel?.font = setFon[UIFont ]
        countingModeLabel.setTitle("Counting Mode".localized, for: .normal)
        //countingModeLabel.titleLabel?.font = UIFont(name:"Futura", size:50)
    }
